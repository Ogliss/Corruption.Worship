...
namespace Corruption.Worship
{
	public class JobGiver_SpectateDutySermon : ThinkNode_JobGiver
	{
		public override Job TryGiveJob(Pawn pawn)
		{
			...
			{
				return JobMaker.MakeJob(WorshipJobDefOf.Corruption_AttendSermon, edifice, centerCell);
			}
			return JobMaker.MakeJob(WorshipJobDefOf.Corruption_AttendSermon, cell, centerCell);
		}
	}
}
