...
{
    public class Dialog_RenameSermon : Window
    {
        private SermonTemplate Sermon;

        private string curName;

        public override Vector2 InitialSize => new Vector2(500f, 200f);

        public Dialog_RenameSermon(SermonTemplate sermon)
        {
            this.Sermon = sermon;
        ...
        public override void DoWindowContents(Rect rect)
        {
            ...
            Widgets.Label(new Rect(0f, 0f, rect.width, rect.height), "RenameSermon".Translate());
